  	...
  	<div class="container">
		...
		<div id="content" class="row">
			<div id="main" class="col-md-12">
				...
				<div id="main-content">
					<section class="center-block alert alert-success" style="width:450px;">
						<p>Something went wrong and student could not be added to the school database at this time, please <a class="alert-link" href="add-student.php">try again</a></p>
